...
<body>
<form action="${pageContext.request.contextPath}/AdminSeeProduct" method="post">
    <TABLE class="layer"   >
        <TR >
    ...
    <c:forEach var="product" items="${requestScope.product}">
        ...
        <TABLE class="layer" >
            <TR >
                ...
                <TD style="width: 80px;">${product.rootId}</TD>
            </TR>
        </TABLE >
        </p>
    </c:forEach>
    <input type="submit" value="назад" name="AdminSeeProduct1">
</form>
</body>
</html>
